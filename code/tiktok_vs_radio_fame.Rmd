...
raw_data <- data.table::fread("../data_in/tiktok_vs_radio_fame_comparison.csv",
  ...
  mutate(plays = as.numeric(str_remove_all(plays,pattern = ",")),
         ...
         time_on_spotify = as.numeric(date_of_record - date_on_spotify))
